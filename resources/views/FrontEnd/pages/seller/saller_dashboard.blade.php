                ...
                <div class="row shadow p-3">
                    ...
                    <div class="col-12 mt-3">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                              <button class="nav-link" id="orderPro-tab" data-bs-toggle="tab" data-bs-target="#orderPro-tab-pane" type="button" role="tab" aria-controls="orderPro-tab-pane" aria-selected="false">Order Process</button>
                            </li>
                            <li class="nav-item" role="presentation">
                              <button class="nav-link" id="dispute-tab" data-bs-toggle="tab" data-bs-target="#dispute-tab-pane" type="button" role="tab" aria-controls="dispute-tab-pane" aria-selected="false">Dispute</button>
                            </li>
                        </ul>
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="about_seller-tab-pane" role="tabpanel" aria-labelledby="about_seller-tab" tabindex="0">
                                <div class="mt-3 w-100" style="border-radius: 5px; {{-- background-color: #bbb4b445; --}} padding: 15px;">
                                    @if (isset($user->about))
                                        {{ $user->about }}
                                        @else
                                       <span class="text-muted"> No Information Found!</span>
                                    @endif
                                </div>
                            </div>
                                    ...
                                    <form action="{{ url('seller_update') }}" method="POST">
                                        ...
                                        <div class="card" style="width: 50rem;">
                                            <div class="card-body">
                                                ...
                                                <div class="mb-3">
                                                    <label for="about" class="form-label  text-start d-flex">Write Something About Yourself</label>
                            ...
                            <div class="tab-pane fade" id="orderPro-tab-pane" role="tabpanel" aria-labelledby="orderPro-tab" tabindex="0">
