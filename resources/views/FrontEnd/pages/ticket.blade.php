                ...
                <div class="row rounded-lg overflow-hidden shadow support_icket mx-1">
                    ...
                    <div class="col-md-7 ps-0 ps-md-1 pe-0 position-relative">
                        <div class="bg-gray ps-3 pe-3 pe-md-2 py-2 bg-light d-flex justify-content-between align-items-center">
                            ...
                            <a title="Close ticket" class="close-ticket text-white close_ticket d-flex align-items-center review-ticket" role="button">
                        ...
                        @if (isset($active_ticket))
                            <form class="bg-light message_form" id="sendMessage" enctype="multipart/form-data">
                                <input type="hidden" value="" name="ticket_id" id="ticket_id">
                                <div class="input-group d-flex align-items-center">
                                    {{-- <input type="file" class="custom-file-input" name="images[]" id="imageUploadInput" accept="jpg,.jpeg,.png,.gif,.bmp,.tiff" multiple> --}}
