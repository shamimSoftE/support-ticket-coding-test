                            ...
                            <tbody>
                                @forelse ($data['orders'] as $order)
                                    ...
                                    <tr>
                                        ...
                                        <td>@if(isset($order->product->name)) {{ $order->product->name }} @endif</td>
                                        <td> {{ $order->product_qty }} </td>
                                        <td>@if(isset($order->seller->name)) {{ $order->seller->name }} @endif</td>
                                        <td>
                                            @switch($order->status)
                                                @case(0)
                                        ...
                                        <td>@if(isset($order->total_amount)) ${{ number_format($order->total_amount) }} @endif</td>
                            ...
                            <tbody>
                                @forelse ($data['order_process'] as $order_pro)
                                    ...
                                    <tr>
                                       ...
                                       <td>@if(isset($order_pro->product->name)) {{ $order_pro->product->name }} @endif</td>
                                        <td> {{ $order_pro->product_qty }} </td>
                                        <td>@if(isset($order_pro->seller->name)) {{ $order_pro->seller->name }} @endif</td>

                                        <td><span class="badge bg-primary">Process</span></td>
                                        <td>@if(isset($order_pro->total_amount)) ${{ number_format($order_pro->total_amount) }} @endif</td>
                            ...
                            <tbody>
                                @forelse ($data['order_delivered'] as $order_deli)
                                    ...
                                    <tr>
                                       ...
                                       <td>@if(isset($order_deli->product->name)) {{ $order_deli->product->name }} @endif</td>
                                        <td> {{ $order_deli->product_qty }} </td>
                                        <td>@if(isset($order_deli->seller->name)) {{ $order_deli->seller->name }} @endif</td>

                                        <td><span class="badge bg-success">Shipped</span></td>
                                        <td>@if(isset($order_deli->total_amount)) ${{ number_format($order_deli->total_amount) }} @endif</td>
                            ...
                            <tbody>
                                ...
                                @forelse ($data['order_disputes'] as $order_dis)
                                    <tr>
                                        ...
                                        <td>@if(isset($order_dis->product->name)) {{ $order_dis->product->name }} @endif</td>
                                        <td> {{ $order_dis->product_qty }} </td>
                                        <td>@if(isset($order_dis->seller->name)) {{ $order_dis->seller->name }} @endif</td>

                                        <td><span class="badge bg-warning">Disputes</span></td>
                                        <td>@if(isset($order_dis->total_amount)) {{ number_format($order_dis->total_amount) }} @endif</td>
                            ...
                            <tbody>
                                ...
                                @forelse ($data['order_cancell'] as $order_cancell)
                                    ...
                                    <tr>
                                       ...
                                       <td>@if(isset($order_cancell->product->name)) {{ $order_cancell->product->name }} @endif</td>
                                        <td> {{ $order_cancell->product_qty }} </td>
                                        <td>@if(isset($order_cancell->seller->name)) {{ $order_cancell->seller->name }} @endif</td>

                                        <td><span class="badge bg-danger">Cancelled</span></td>
                                        <td>@if(isset($order_cancell->total_amount)) ${{ number_format($order_cancell->total_amount) }} @endif</td>
                            ...
                            <tbody>
                                @forelse ($data['order_complete'] as $order_complete)
                                    <tr>
                                        ...
                                        <td>@if(isset($order_complete->product->name)) {{ $order_complete->product->name }} @endif</td>
                                        <td> {{ $order_complete->product_qty }} </td>
                                        <td>@if(isset($order_complete->seller->name)) {{ $order_complete->seller->name }} @endif</td>

                                        <td><span class="badge bg-secondary">Completed</span></td>
                                        <td>@if(isset($order_complete->total_amount)) ${{ number_format($order_complete->total_amount) }} @endif</td>
