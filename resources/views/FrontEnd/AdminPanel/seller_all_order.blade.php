                                ...
                                <tbody>
                                    @forelse ($data['orders'] as $order)
                                        ...
                                        <tr>
                                            ...
                                            <td>@if(isset($product->price)) ${{ number_format($order->total_amount) }} @endif</td>
                                ...
                                <tbody>
                                    @forelse ($data['order_process'] as $order_pro)
                                        ...
                                        <tr>
                                            ...
                                            <td>@if(isset($product->price)) ${{ number_format($order_pro->total_amount) }} @endif</td>
                                ...
                                <tbody>
                                    @forelse ($data['order_delivered'] as $order_deli)
                                        ...
                                        <tr>
                                            ...
                                            <td>@if(isset($product->price)) ${{ number_format($order_deli->total_amount) }} @endif</td>
                                ...
                                <tbody>
                                    ...
                                    @forelse ($data['order_disputes'] as $order_dis)
                                        ...
                                        <tr>
                                            ...
                                            <td>@if(isset($product->price)) ${{ number_format($order_dis->total_amount) }} @endif</td>
                                ...
                                <tbody>
                                    ...
                                    @forelse ($data['order_cancell'] as $order_cancell)
                                        ...
                                        <tr>
                                            ...
                                            <td>@if(isset($product->price)) ${{ number_format($order_cancell->total_amount) }} @endif</td>
                                ...
                                <tbody>
                                    @forelse ($data['order_complete'] as $order_complete)
                                        ...
                                        <tr>
                                            ...
                                            <td>@if(isset($product->price)) ${{ number_format($order_complete->total_amount) }} @endif</td>
