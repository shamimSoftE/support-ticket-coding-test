                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6 col-xl-6 col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control @error('image') is-invalid @enderror" type="number" value="{{ $product->qty }}" readonly id="qty">
                                                            @error('qty')
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-4 col-xl-4 col-md-4">
                                                        <div class="mb-3 form-check">
                                                            <input type="checkbox" class="form-check-input" name="delivery_type" id="manual" data="{{ $product->delivery_type }}" value="1" @if($product->delivery_type == 1) checked @endif>
                                                            <label class="form-check-label" for="manual">Manual</label>
                                                        </div>
            
                                                        <div class="mb-3 form-check">
                                                            <input type="checkbox" class="form-check-input" name="delivery_type" id="unlimited" value="2" @if($product->delivery_type == 2) checked @endif>
                                                            <label class="form-check-label" for="unlimited">Unlimited</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-8 col-xl-8 col-md-8">
                                                        <div class="mb-3 form-check">
                                                            <input type="checkbox" class="form-check-input" name="delivery_type"  id="auto_delivery" value="3" @if($product->delivery_type == 3) checked @endif>
                                                            <label class="form-check-label" for="auto_delivery">Auto Delivery</label>
                                                        </div>
            
                                                        <div class="mb-3 form-check">
                                                            <input type="checkbox" class="form-check-input" name="delivery_type" id="service" value="4" @if($product->delivery_type == 4) checked @endif>
