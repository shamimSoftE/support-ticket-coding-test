...
@section('title', 'Vendor Purchase List')
                ...
                <div class="mb-4 inner-content">
                    <div class="row">
                        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12">
                            ...
                            <h3 class="pb-3 border-bottom text-start">List Of Vendor Purchase</h3>



                            {{-- User list --}}
                            <div class="table-responsive mb-5">
                                @if(isset($vendor_purchase))
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            @forelse($vendor_purchase as $key=> $order)

                                                @foreach($order as $ord)
                                                    <tr>
                                                        <td>
                                                            @if(isset($ord->seller->name))
                                                                <span class="badge text-bg-success"> {{ $ord->seller->name }}</span>
                                                            @endif
                                                        </td>
                                                        <td>
                                                            @if(isset($ord->product->price))
                                                                <span class="">
                                                        ...
                                                        <td>
                                                            <span class=""> {{ $ord->created_at->diffForHumans()  }} </span>
                                                        </td>
                                                    </tr>
                                                @endforeach
