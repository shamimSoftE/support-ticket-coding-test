        ...
        <div class="col-lg-2 col-md-1">
            <div class="shadow rounded pl-1">
                <div class="list-group rounded-0 border-0">                    
                    <a href="{{ url('support-ticket') }}" class="list-group-item fw-bold 
                    @if(request()->segment(1) == 'support-ticket') c_active @endif" 
                    style="padding: 12px"> Tickets </a>
                    @if (auth()->user()->type == 3)
                    ...
                    <div class="row rounded-lg overflow-hidden shadow support_icket mx-1">
                        ...
                        <div class="col-md-7 ps-0 ps-md-1 pe-0 position-relative">
                            <div class="bg-gray ps-3 pe-3 pe-md-2 py-2 bg-light d-flex justify-content-between align-items-center">
                                ...
                                <a title="Close ticket" class="close-ticket text-white close_ticket d-flex align-items-center review-ticket" onclick="close_ticket()" role="button" >
                            ...
                            <form class="bg-light message_form" id="sendMessage">
                                <input type="hidden" value="" name="ticket_id" id="ticket_id">
                                <div class="input-group d-flex align-items-center">
                                    <textarea name="message" id="" class="form-control message-input message mb-3"></textarea>
...
<script>
            ...
            success: function(data) {
                ...
                if (data[0] == "success") {
                    ...
                    if(data[2].status==1){
                        ...
                        $('.message_form').show();
                        // $('.chat-app-window').css('height','calc(100% - 65px)')
                    }else{
                        // $('.close_ticket').show();
                        $('.close_ticket').attr("style", "display: none !important");
                        $('.message_form').hide();
                        // $('.chat-app-window').css('height','calc(100% - 65px - 65px)')
                    }
                }
            }
        });
    ...
    function close_ticket() {
        let ticket_id = $('.ticket_title').text();
